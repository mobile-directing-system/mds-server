module github.com/mobile-directing-system/mds-server/services/go/radio-delivery-svc
...
require (
	...
	github.com/mobile-directing-system/mds-server/services/go/logistics-svc v0.0.0-20220920212347-b359219b2852
)
