...
import (
	...
	"github.com/mobile-directing-system/mds-server/services/go/intelligence-svc/controller"
	"github.com/mobile-directing-system/mds-server/services/go/intelligence-svc/endpoints"
	"github.com/mobile-directing-system/mds-server/services/go/intelligence-svc/eventport"
...
const kafkaGroupID = "mds-intelligence-svc"
...
func Run(ctx context.Context) error {
	...
	logger, err := logging.NewLogger("intelligence-svc", c.LogLevel)
	if err != nil {
