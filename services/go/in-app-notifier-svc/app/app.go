...
import (
	...
	"github.com/mobile-directing-system/mds-server/services/go/in-app-notifier-svc/controller"
	"github.com/mobile-directing-system/mds-server/services/go/in-app-notifier-svc/endpoints"
	"github.com/mobile-directing-system/mds-server/services/go/in-app-notifier-svc/eventport"
	"github.com/mobile-directing-system/mds-server/services/go/in-app-notifier-svc/store"
	"github.com/mobile-directing-system/mds-server/services/go/in-app-notifier-svc/ws"
...
const kafkaGroupID = "mds-in-app-notifier-svc"
...
func Run(ctx context.Context) error {
	...
	logger, err := logging.NewLogger("in-app-notifier-svc", c.LogLevel)
	if err != nil {
	...
	ctrl := controller.NewController(logger.Named("controller"), sqlDB, store.NewMall(), eventPort)
