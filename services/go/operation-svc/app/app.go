...
import (
	...
	"github.com/mobile-directing-system/mds-server/services/go/operation-svc/controller"
	"github.com/mobile-directing-system/mds-server/services/go/operation-svc/endpoints"
	"github.com/mobile-directing-system/mds-server/services/go/operation-svc/eventport"
...
func Run(ctx context.Context) error {
	...
	logger, err := logging.NewLogger("operation-svc", c.LogLevel)
	if err != nil {
